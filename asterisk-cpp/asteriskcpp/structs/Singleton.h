...
public:
	...
	template<typename T1, typename T2, typename T3, typename T4> static boost::shared_ptr<C> getInstance(T1& c_arg1, T2& c_arg2, T3& c_arg3, T4& c_arg4) {
		boost::recursive_mutex::scoped_lock cLock(m_mutexGetSingleton);
		C* pc;
	...
	template<typename T1, typename T2, typename T3, typename T4, typename T5> static boost::shared_ptr<C> getInstance(T1& c_arg1, T2& c_arg2, T3& c_arg3,
			T4& c_arg4, T5& c_arg5) {
		boost::recursive_mutex::scoped_lock cLock(m_mutexGetSingleton);
		C* pc;
